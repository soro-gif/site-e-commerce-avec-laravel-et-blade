...
<div class="d-flex justify-content-end">
    ...
    <a href="{{ route('admin.tag.create') }}" class="btn btn-success m-1">
                ...
                @foreach($tags as $tag)
						<tr><td>{{ $tag->id }}</td>
                            ...
                            <div class="form-group d-flex" id="preview_imageUrl" style="max-width: 100%;">
                                <img src="{{  Str::startsWith($tag->imageUrl, 'http') ? $tag->imageUrl : Storage::url($tag->imageUrl) }}"
                                     alt="Prévisualisation de l'image"
                                     style="max-width: 100px; display: block;">
                            </div>
                        </td>
						<td>
                    <a href="{{ route('admin.tag.show', ['id' => $tag->id]) }}" class="btn btn-primary btn-sm">
                        <i class="fa-solid fa-eye"></i>
                    </a>
                    <a href="{{ route('admin.tag.edit', ['id' => $tag->id]) }}" class="btn btn-success btn-sm">
                        <i class="fa-solid fa-pen-to-square"></i>
                    </a>
                    <a href="#" data-id="{{ $tag->id }}" class="btn btn-danger btn-sm deleteBtn">
...
@section('scripts')
    ...
    <script>
        ...
        checkbox.onchange = async (event) => {
            ...
            const response = await fetch('/admin/tags/speed/' + id, {
                method: 'PUT',
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const tableHeaders = document.querySelectorAll('#Tag th');
            ...
            tableHeaders.forEach(function(header, index) {
                ...
                const savedSelection = localStorage.getItem('selectedColumns#Tag');
        ...
        function toggleColumn(columnIndex, show) {
            const dataTable = document.getElementById('Tag');
        ...
        function saveSelection() {
            ...
            localStorage.setItem('selectedColumns#Tag', JSON.stringify(selectedColumns));
        }
