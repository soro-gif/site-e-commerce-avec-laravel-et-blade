...
<div class="d-flex justify-content-end">
    ...
    <a href="{{ route('admin.contact.create') }}" class="btn btn-success m-1">
        ...
        <table  id="Contact" class="table">
            ...
            <tbody>
                @foreach($contacts as $contact)
                    ...
                    <a href="#" data-id="{{ $contact->id }}" class="btn btn-danger btn-sm deleteBtn">
...
@section('scripts')
    ...
    <script>
        ...
        checkbox.onchange = async (event) => {
            ...
            const response = await fetch('/admin/contacts/speed/' + id, {
                method: 'PUT',
        ...
        deleteButtons.forEach(deleteButton => {
            deleteButton.addEventListener('click', (event)=>{
                ...
                confirmDeleteBtn.addEventListener('click',async ()=>{
                    const csrfToken = document.head.querySelector('meta[name="csrf-token"]').content;
                    const response = await fetch('/admin/contacts/delete/'+id , {
                        method: 'DELETE',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-CSRF-TOKEN': csrfToken
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const tableHeaders = document.querySelectorAll('#Contact th');
            ...
            tableHeaders.forEach(function(header, index) {
                ...
                const savedSelection = localStorage.getItem('selectedColumns#Contact');
        ...
        function toggleColumn(columnIndex, show) {
            const dataTable = document.getElementById('Contact');
        ...
        function saveSelection() {
            ...
            localStorage.setItem('selectedColumns#Contact', JSON.stringify(selectedColumns));
        }
